...
public class IndexFiltro implements Filter{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if(tipo!=null)
        {
            ...
            {
               ((HttpServletResponse)response).sendRedirect("/ParcialAMJava/faces/planta/gestionProyectos.xhtml");
            }else{
                if(tipo.equals("contratista")){  
                    ((HttpServletResponse)response).sendRedirect("/ParcialAMJava/faces/contratista/gestionDependientes.xhtml");
                }else{
